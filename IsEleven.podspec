#
#  Be sure to run `pod spec lint IsEleven.podspec' to ensure this is a
...
This CocoaPods library checks if given data equals eleven
  ...
  # Or just: spec.author    = "sergs582"
  # spec.authors            = { "sergs582" => "kurba37@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/sergs582"
